...
export default function NoticeBoard() {
  ...
  return (
    <m.div variants={sectionVariants} initial="hidden" animate="visible" transition={{ duration: 0.5 }} className="select-none bg-blue-800">
      <div className="mx-auto flex min-h-screen min-w-[350px] max-w-screen-pc flex-col items-center space-y-5 p-14 px-5">
        <span className="mb-20 text-6xl font-bold text-backend">🫧 공지사항 🫧</span>
