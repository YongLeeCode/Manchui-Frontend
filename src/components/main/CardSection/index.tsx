...
export default function CardSection({ gathering }: CardSectionProps) {
  return (
    <div className="group flex aspect-square min-h-[170px] flex-col overflow-hidden rounded-2xl bg-white shadow-[0_4px_16px_0_rgba(17,34,17,0.05)] mobile:aspect-auto mobile:h-[170px] mobile:flex-row tablet:aspect-square tablet:size-full tablet:min-h-[290px] tablet:flex-col">
      {/* 이미지 영역 */}
