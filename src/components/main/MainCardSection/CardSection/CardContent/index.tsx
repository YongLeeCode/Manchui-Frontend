    ...
    <div className="relative flex h-1/2 min-h-36 w-full cursor-pointer flex-col justify-between overflow-hidden px-5 py-4 mobile:h-full tablet:w-full">
      <div className="mb-3 flex justify-between">
        <div className="flex flex-col">
          <span className="text-pretty text-sm font-bold mobile:text-base tablet:text-xl">{groupName}</span>
          <span className={`pb-3 text-xs font-medium text-gray-500 mobile:text-sm tablet:text-base ${closed && '!text-gray-200'}`}>
            {category} | {location}
          </span>
